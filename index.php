<?php get_header(); ?>
	...
	<div class = "container" style = "height: 250px; display: table; padding: 5% 0;">
		<div class = "img-oqf col-xs-12 col-sm-5 col-md-5 col-lg-5" style = "padding-bottom: 30px">
		...
		<div class = "col-xs-12 col-sm-5 col-md-5 col-lg-5" style = "display: table-cell; vertical-align: middle; margin-bottom: 5px;">
