...
<div class = "clearfix">
	...
	<div style = "background: lightgrey">
		<div class = "container" style = "padding: 40px 0">
			<div class = "align-mobile">
				<h1 style = "padding-top: 20px" class = "caps col-md-3">vistoria para entrega da obra</h1>
	...
	<div>
		<div class = "container" style = "padding: 40px 0">
			<div class = "align-mobile">
				<h1 class = "caps col-md-3" style = "padding-right: 55px">gerenciamento do Pós Obra - Assistência Técnica</h1>
	...
	<div style = "background: lightgrey">
		<div class = "container" style = "padding: 40px 0">
			<div class = "align-mobile">
				<h1 class = "caps col-md-3" style = "padding-right: 55px">Gerenciamento do Pós Obra - Unidades em Estoque</h1>
